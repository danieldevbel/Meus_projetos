...
const Jogo = ({ verificarLetra, palavraEscolhida, dicaEscolhida, letras, advinharLetras, letrasErradas, tentativas, pontuacao }) => {
  ...
  return (
    <div className="game">
      ...
      <h3 className="tip">
        Dica sobre a palavra: <span>{dicaEscolhida}</span>
      </h3>
